...
const sendDistressSignal = require('./routes/twilioRoute');
...
// 
// app.post('/sendDistressSignal', (req, res) => {
...
//       const message = `Distress signal from SOS app. User needs immediate assistance. Location: Latitude: XX.XXXXX, Longitude: YY.YYYYY.`; // You can include the user's location in the message
//       client.messages
//         .create({
//           body: message,
...
//     sendDistressSignal(emergencyContacts);
...
app.post('/sendDistressSignal', async (req, res) => {
